          ...
          <ScrollReveal direction="up" delay={0.05}>
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Instagram"
                className="w-9 h-9 rounded-full bg-transparent border border-white/10 flex items-center justify-center text-[#F8F3E7] hover:bg-white transition-colors"
              >
                <InstagramIcon />
              </a>
              <a
                ...
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="w-9 h-9 rounded-full bg-transparent border border-white/10 flex items-center justify-center text-[#f10101] hover:bg-[#fff] hover:text-[#f10101] transition-colors"
              >
                <YoutubeIcon />
              </a>
              <a
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="w-9 h-9 rounded-full bg-transparent border border-white/10 flex items-center justify-center text-[#25D366] hover:bg-[#25D366] hover:text-white transition-colors"
              >
                <WhatsappIcon />
              </a>
            </div>
