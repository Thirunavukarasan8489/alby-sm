...
export default function ContactPage() {
  ...
  const faqs = [
    {
      ...
      answer:
        "Yes — every new student gets one free trial class before enrolling, across any of our three instruments.",
    },
    {
      question: "What age can my child start?",
      answer:
        "Piano and Keyboard classes are open from age 6, and Guitar from age 8, though we assess each child individually.",
    },
    {
      question: "Do you offer 1-on-1 lessons?",
      answer:
        "Yes, both small-group and one-on-one formats are available depending on the batch and instrument.",
    },
    {
      question: "Do I need to own an instrument to start?",
      answer:
        "Not for your first few classes — we'll guide you on what to buy once you're ready to practice at home.",
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-[#F8F3E7] text-[#2B2420]">
      ...
      {/* ---------- PAGE HERO ---------- */}
      <section className="bg-[radial-gradient(ellipse_at_75%_20%,rgba(232,163,61,0.18),transparent_55%),linear-gradient(180deg,#211126_0%,#2c1732_100%)] text-[#F8F3E7] pt-[70px] pb-[55px] px-6 text-center">
        <div className="max-w-[1140px] mx-auto">
          ...
          <h1 className="text-3xl sm:text-5xl lg:text-[58px] font-serif tracking-normal mt-3.5 mb-4 leading-[1.05]">
            Book your{" "}
            <i className="italic text-[#E8A33D] not-italic">trial class</i>
          </h1>
      ...
      <section className="bg-[#17514E] text-[#F8F3E7] py-[70px] sm:py-[90px] px-6">
        <div className="max-w-[1140px] mx-auto grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-12 lg:gap-[60px]">
          <div>
            <h2 className="text-3xl sm:text-[38px] font-serif text-[#F8F3E7]">
              Let&apos;s talk music
            </h2>
            <p className="text-[#d7e4e2] text-base leading-[1.7] mt-4 mb-[30px]">
              Reach out with any questions about batches, timings or fees — or
              just come by the academy for a visit.
            </p>
              ...
              <div className="flex gap-3.5 items-start py-4 border-b border-white/12">
                ...
                <div>
                  ...
                  <span className="text-[13.5px] text-[#c9dedb]">
                    Alby.sm Music Academy, Coimbatore, Tamil Nadu
                  </span>
                </div>
              </div>
          ...
          <form className="bg-white/6 border border-white/15 rounded-[6px] p-7 sm:p-[34px] flex flex-col gap-4">
            ...
            <button
              type="submit"
              className="bg-[#E8A33D] text-[#211126] border-none p-3.5 font-semibold text-[15.5px] rounded-[3px] cursor-pointer transition-all hover:bg-white hover:-translate-y-0.5 mt-1.5"
            >
              Send Request
            </button>
          </form>
