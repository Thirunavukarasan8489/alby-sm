...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-[#F8F3E7] text-[#2B2420]">
      {/* ---------- PAGE HERO ---------- */}
      <section className="bg-[radial-gradient(ellipse_at_75%_20%,rgba(232,163,61,0.18),transparent_55%),linear-gradient(180deg,#211126_0%,#2c1732_100%)] text-[#F8F3E7] py-[70px] px-6 text-center">
      ...
      <section className="py-[70px] sm:py-[90px] px-6 bg-[#211126] text-[#F8F3E7]">
        ...
        <div className="max-w-[1140px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-6.5">
          <div className="bg-[#2c1732] border border-[#E8A33D]/18 rounded-[4px] p-7 sm:p-[32px_26px] transition-all duration-250 hover:-translate-y-1.5 hover:border-[#E8A33D]">
          ...
          <div className="bg-[#2c1732] border border-[#E8A33D]/18 rounded-[4px] p-7 sm:p-[32px_26px] transition-all duration-250 hover:-translate-y-1.5 hover:border-[#E8A33D]">
            ...
            <p className="text-[14.5px] leading-[1.65] text-[#cfc3b3]">
              Every few weeks, students play something whole — not drills. Real
              progress should sound like real music.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-[70px] sm:py-[90px] px-6 bg-[#211126] text-[#F8F3E7]">
        ...
        <div className="max-w-[1140px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-6.5">
          <div className="bg-[#2c1732] rounded-[4px] overflow-hidden border border-[#E8A33D]/15 transition-all duration-250 hover:-translate-y-1.5">
            <Image
          ...
          <div className="bg-[#2c1732] rounded-[4px] overflow-hidden border border-[#E8A33D]/15 transition-all duration-250 hover:-translate-y-1.5">
            ...
            <div className="p-[22px]">
              ...
              <p className="text-[14px] text-[#cfc3b3] leading-[1.6]">
                Acoustic and electric guitarist focused on song-first, practical
                learning.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#2c1732] rounded-[4px] overflow-hidden border border-[#E8A33D]/15 transition-all duration-250 hover:-translate-y-1.5">
            ...
            <div className="p-[22px]">
              ...
              <p className="text-[14px] text-[#cfc3b3] leading-[1.6]">
                Performance keyboardist teaching modern arrangement and layered
                sound.
              </p>
            </div>
          </div>
